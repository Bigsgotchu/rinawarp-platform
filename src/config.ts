export default {
  monitoring: {
    ...
    thresholds: {
      slowDeliveryMs: parseInt(
        process.env.SLOW_DELIVERY_THRESHOLD_MS || '10000'
      ), // 10 seconds
    ...
    opentelemetry: {
      ...
      serviceName:
        process.env.OPENTELEMETRY_SERVICE_NAME || 'rinawarp-analytics',
    },
  },
  security: {
  ...
  email: {
    ...
    assets: {
      logoUrl:
        process.env.EMAIL_LOGO_URL || 'https://rinawarp.com/assets/logo.png',
    },
  },
  analytics: {
    reports: {
