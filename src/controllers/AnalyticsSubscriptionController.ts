...
class AnalyticsSubscriptionController {
   ...
   */
  async getSubscriptionPreferences(req: Request, res: Response, next: NextFunction) {
    try {
   ...
   */
  async updateSubscriptionPreferences(req: Request, res: Response, next: NextFunction) {
    try {
