...
class CommandLearningService {
  ...
  async learnFromCommand(
    ...
    try {
      ...
      if (result.exitCode === 0) {
        ...
        await this.redis.lpush(contextKey, JSON.stringify({
          ...context,
  ...
  private contextMatch(context1: CommandContext, context2: CommandContext): boolean {
    ...
    return (
      ...
      (context1.previousCommands &&
       ...
       this.arrayIntersection(context1.previousCommands, context2.previousCommands).length > 0)
    );
  }
